...
- Halilovic, A., & Krivic, S. (2023, December). The influence of a robot’s personality on real-time explanations of its navigation. In International Conference on Social Robotics (pp. 133-147). Singapore: Springer Nature Singapore. [Link](https://link.springer.com/chapter/10.1007/978-981-99-8718-4_12)
- Han, Z., & Yanco, H. (2023). Communicating missing causal information to explain a robot’s past behavior. ACM Transactions on Human-Robot Interaction, 12(1), 1-45. [Link](https://dl.acm.org/doi/full/10.1145/3568024)
- Rosenthal, S., Vichivanives, P., & Carter, E. (2022). The impact of route descriptions on human expectations for robot navigation. ACM Transactions on Human-Robot Interaction (THRI), 11(4), 1-19. [Link](https://dl.acm.org/doi/full/10.1145/3526104)
- Sakai, T., Nagai, T., & Abe, K. (2023). Implementation and Evaluation of Algorithms for Realizing Explainable Autonomous Robots. IEEE Access, 11, 105299-105313. [Link](https://ieeexplore.ieee.org/abstract/document/10210548)
- Arnold, T., Kasenberg, D., & Scheutz, M. (2021). Explaining in time: Meeting interactive standards of explanation for robotic systems. ACM Transactions on Human-Robot Interaction (THRI), 10(3), 1-23. [Link](https://dl.acm.org/doi/abs/10.1145/3457183)
- Cruz, F., Dazeley, R., Vamplew, P., & Moreira, I. (2023). Explainable robotic systems: Understanding goal-driven actions in a reinforcement learning scenario. Neural Computing and Applications, 35(25), 18113-18130. [Link](https://link.springer.com/article/10.1007/s00521-021-06425-5)
- Hu, S., & Nagai, T. (2023). Explainable autonomous robots in continuous state space based on graph-structured world model. Advanced Robotics, 37(16), 1025-1041. [Link](https://www.tandfonline.com/doi/full/10.1080/01691864.2023.2236189)
- Bogatarkan, A., & Erdem, E. (2020). Explanation generation for multi-modal multi-agent path finding with optimal resource utilization using answer set programming. Theory and Practice of Logic Programming, 20(6), 974-989. [Link](https://www.cambridge.org/core/journals/theory-and-practice-of-logic-programming/article/abs/explanation-generation-for-multimodal-multiagent-path-finding-with-optimal-resource-utilization-using-answer-set-programming/3E4C9201015EBBE5924C7B2215263C34)
- Mualla, Y., Tchappi, I., Kampik, T., Najjar, A., Calvaresi, D., Abbas-Turki, A., ... & Nicolle, C. (2022). The quest of parsimonious XAI: A human-agent architecture for explanation formulation. Artificial intelligence, 302, 103573. [Link](https://www.sciencedirect.com/science/article/pii/S0004370221001247?casa_token=WNXJlHIjJb4AAAAA:Zwc2vC1qcc6W-Cv3W30XDUM73sbjXxZRrnIgETN_DPxpkZOTMFmbkaAMgcwPjbXEwE-WgcTn)
- Zakershahrak, M., Gong, Z., Sadassivam, N., & Zhang, Y. (2020, October). Online explanation generation for planning tasks in human-robot teaming. In 2020 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS) (pp. 6304-6310). IEEE. [Link](https://ieeexplore.ieee.org/abstract/document/9341792?casa_token=hlSS1cAiuF8AAAAA:cwJZQA0LyZqA4Vl2S9VANWbOfyqwFhBdTQ46QFUeeJgvGEmEgUAkC-0N7X_Cjd22zRkBTOhIsK4)
- Mota, T., & Sridharan, M. (2021, August). Answer me this: constructing disambiguation queries for explanation generation in robotics. In 2021 IEEE International Conference on Development and Learning (ICDL) (pp. 1-8). IEEE. [Link](https://ieeexplore.ieee.org/abstract/document/9515605?casa_token=nJUusglbOF8AAAAA:EaDYVtSDKDksPThArHt8uS8RCJzSa_5KVGdzFMxp85h2oAsaLVx8Xxdyj0HD1KmejjNsHLcVdkM)
- Gong, Z., & Zhang, Y. (2018, August). Behavior explanation as intention signaling in human-robot teaming. In 2018 27th IEEE International Symposium on Robot and Human Interactive Communication (RO-MAN) (pp. 1005-1011). IEEE. [Link](https://ieeexplore.ieee.org/abstract/document/8525675?casa_token=8p8CEStwiJAAAAAA:6YaVTu9UAwiE_8Xai_bAfSdWWNdVo-oq7QM77EJl479btMTYN4_U_2LaFpwci-v5Y31elQ2SRfM)
- Han, Z., Giger, D., Allspaw, J., Lee, M. S., Admoni, H., & Yanco, H. A. (2021). Building the foundation of robot explanation generation using behavior trees. ACM Transactions on Human-Robot Interaction (THRI), 10(3), 1-31. [Link](https://dl.acm.org/doi/abs/10.1145/3457185)
- Schroeter, N., Cruz, F., & Wermter, S. (2022). Introspection-based explainable reinforcement learning in episodic and non-episodic scenarios. arXiv preprint arXiv:2211.12930. [Link](https://arxiv.org/abs/2211.12930)
- Gao, X., Gong, R., Zhao, Y., Wang, S., Shu, T., & Zhu, S. C. (2020, August). Joint mind modeling for explanation generation in complex human-robot collaborative tasks. In 2020 29th IEEE international conference on robot and human interactive communication (RO-MAN) (pp. 1119-1126). IEEE. [Link](https://ieeexplore.ieee.org/abstract/document/9223595?casa_token=KCFTFRid3q4AAAAA:WZCqBqVRzqun8xA1JKnFNE3SOR4jAp2HJ42LUmBIHADvpteVW-2aVU3Sss5WX7ob6JZxz7ZhajI)
- Brandao, M., Canal, G., Krivić, S., & Magazzeni, D. (2021, May). Towards providing explanations for robot motion planning. In 2021 IEEE International Conference on Robotics and Automation (ICRA) (pp. 3927-3933). IEEE. [Link](https://ieeexplore.ieee.org/abstract/document/9562003?casa_token=mlXLkqNL-QsAAAAA:7-LiL1MRU2ICHtWlJKxjcf_Jd2tJC78htRmqlR92jqpNcVrnTdS_5q2-DZPbh8WWGELmXiI22Oc)
- Chen, S., Boggess, K., & Feng, L. (2020, October). Towards transparent robotic planning via contrastive explanations. In 2020 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS) (pp. 6593-6598). IEEE. [Link](https://ieeexplore.ieee.org/abstract/document/9341773?casa_token=pox3btZgW88AAAAA:yxKmr8hqqTSKUDsC_L5wKvzG-fJfXSWRDnRbdcivzEB3SFGUjWSKW4vBxSf_tpTsqWUmstt-M-E)
- Olivares-Alarcos, A., Foix, S., & Alenyà, G. (2021). Knowledge representation for explainability in collaborative robotics and adaptation. [Link](https://digital.csic.es/handle/10261/263342)
- Brandao, M., Coles, A., & Magazzeni, D. (2021, May). Explaining path plan optimality: Fast explanation methods for navigation meshes using full and incremental inverse optimization. In Proceedings of the International Conference on Automated Planning and Scheduling (Vol. 31, pp. 56-64). [Link](https://ojs.aaai.org/index.php/ICAPS/article/view/15947)
- Halilovic, A., & Lindner, F. (2023, March). Visuo-Textual Explanations of a Robot's Navigational Choices. In Companion of the 2023 ACM/IEEE International Conference on Human-Robot Interaction (pp. 531-535). [Link](https://dl.acm.org/doi/abs/10.1145/3568294.3580141)
- 
...
- Anjomshoae, S., Najjar, A., Calvaresi, D., & Främling, K. (2019). Explainable agents and robots: Results from a systematic literature review. In 18th International Conference on Autonomous Agents and Multiagent Systems (AAMAS 2019), Montreal, Canada, May 13–17, 2019 (pp. 1078-1088). International Foundation for Autonomous Agents and Multiagent Systems.[Link](https://www.diva-portal.org/smash/record.jsf?pid=diva2%3A1303810&dswid=7739)
- Wallkötter, S., Tulli, S., Castellano, G., Paiva, A., & Chetouani, M. (2021). Explainable embodied agents through social cues: a review. ACM Transactions on Human-Robot Interaction (THRI), 10(3), 1-24. [Link](https://dl.acm.org/doi/abs/10.1145/3457188)
- Vilone, G., & Longo, L. (2020). Explainable artificial intelligence: a systematic review. arXiv preprint arXiv:2006.00093. [Link](https://arxiv.org/abs/2006.00093)
- Rosenfeld, A., & Richardson, A. (2019). Explainability in human–agent systems. Autonomous agents and multi-agent systems, 33, 673-705. [Link](https://link.springer.com/article/10.1007/s10458-019-09408-y)
- Setchi, R., Dehkordi, M. B., & Khan, J. S. (2020). Explainable robotics in human-robot interactions. Procedia Computer Science, 176, 3057-3066. [Link](https://www.sciencedirect.com/science/article/pii/S1877050920321001?via%3Dihub)
- Yang, S. C. H., Folke, N. E. T., & Shafto, P. (2022, June). A psychological theory of explainability. In International Conference on Machine Learning (pp. 25007-25021). PMLR. [Link](https://proceedings.mlr.press/v162/yang22c.html)
